        ...
        <div class="mx-20 mt-28">
            ...
            <div class="grid lg:grid-cols-3 gap-4 w-full">
                @foreach ($article as $articles)
                    <div class="lg:w-80 max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800 text-justify">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-200 mb-3">{{$articles->description}}</p>
                        <a href="{{$articles->getMedia()[0]['original_url']}}" target="blank" class="px-5 py-1 bg-blue-500 text-white rounded-lg ">
                            PDF
                        </a>
                    </div>
                @endforeach
