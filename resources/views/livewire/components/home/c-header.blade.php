        ...
        <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Log ine</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <li class="splide__slide">
                  <div  style="background-image: url({{asset('assets/i.jpg')}})">
                      ...
                      <div class="" style="background-color: rgba(0, 0, 0, .7)">
                          ...
                          <div class="relative isolate px-6  lg:px-8 py-10">
