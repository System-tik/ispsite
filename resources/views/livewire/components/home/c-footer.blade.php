        ...
        <div class="mx-8">
            <div class="flex mx-16 py-5">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <a href="#">
                            <img class="w-auto h-7" src="{{asset('assets/logo.png')}}" alt="">
                        </a>
            ...
            <div>
                <p class="text-center text-gray-500 dark:text-gray-400 text-xs">© ISP/Mbanza Ngungu 2024 - By <a href="https://systematik.tech/" target="_blank"  class="text-blue-600 underline">SYSTEMATIK SAS</a> All rights reserved</p>
            </div>
        </div>
    </footer>
</div>
